...
4. **주제 문구 그대로 사용 금지**: 주제는 글의 방향을 알려주는 것일 뿐입니다. 제목에 주제 문장을 그대로 넣지 마세요. 키워드만 활용하여 완전히 새로운 제목을 만드세요.
   - ❌ 주제가 "탈모 고생한 20대 여자 해결법"일 때 → "탈모 고생한 20대 여자 해결법, 이걸 몰랐다면..."
   - ✅ 주제가 "탈모 고생한 20대 여자 해결법"일 때 → "매일 아침 베개 위 머리카락에 울던 20대, 지금은요?"
